...
If you're not a fan of the approach above, you might like this [alternative folder structure](https://www.joshwcomeau.com/react/file-structure/) by Josh Comeau instead.
