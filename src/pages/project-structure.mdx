...
If you're not a fan of the approach above, you might like this [alternative folder structure](https://www.joshwcomeau.com/react/file-structure/) by Josh Comeau instead. The article is great read regardless if you end up adopting his recommendations, because he walks you through the things you should be considering when making decisions for organizing your project.
