...
- <Resoure url='https://www.browserstack.com/guide/visual-regression-testing'>Visual Regression</Resource> - pixel-perfect screenshot comparison to know all changes, both big and small
