...
import { FAQ, Question, Answer, QuestionText } from '@/components/FAQ'
...
export const sections = [
  ...
  { title: 'Tips for using Jest', id: 'jest-tips' },
  { title: 'Tips for using RTL', id: 'rtl-tips' },
...
- [Testing Overview](https://abseil.io/resources/swe-book/html/ch11.html) by Adam Bender
