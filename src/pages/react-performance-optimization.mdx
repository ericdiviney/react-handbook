...
Performance in React apps should be thought of in ***2 ways***:

1. Browser (Loading) Performance - Compressing &amp; loading code/assets (mostly *Non-React* things)
2. Framework (Runtime) Performance - CPU &amp; rendering issues (mostly *React-specific* things)
...
Send as little code/media as possible over the network, and optimize everything 
	...
	- Various Methods of Code Splitting
		...
		- What is [Lazy Loading](https://developer.mozilla.org/en-US/docs/Web/Performance/Lazy_loading)
		- Using [lazy](https://react.dev/reference/react/lazy) and [Suspense](https://react.dev/reference/react/Suspense) to [lazy-load](https://blog.bitsrc.io/lazy-loading-react-components-with-react-lazy-and-suspense-f05c4cfde10c) components or pages
...
Articles about optimizing JavaScript/React performance
