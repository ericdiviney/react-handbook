...
***There's a lot of great content/advice out there (besides the docs) and we want to centralize it.*** The flexibility of React forces us to make so many choices as engineers/architects - and that's precisely why there's a need for a guide like this.
