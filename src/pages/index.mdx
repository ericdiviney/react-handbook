...
**Disclaimer:** These are not official recommendations of the React framework or the core team. The recommendations here will show you how to do things in a certain way. You can implement only what you see fit for your project and team. 

To read more about the community behind this website and why we built it [read here](/about).