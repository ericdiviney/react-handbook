...
export const sections = [
    ...
    { title: '3) Flux vs. Proxy', id: '3-flux-vs-proxy-direction-of-data-flow' },
...
The way these data-fetching libraries work is they cache the response of each API endpoint that's getting requests from your app. So when you have multiple components consuming the same endpoint data - it only gets hit once instead of 3 times (once for each component). 
...
If you'd like to read more about how Contexts can lead to performance problems, continue reading through this section - otherwise, you can skip ahead to <a href="#3-module-vs-atomic-vs-proxy">Global Stores</a>. 
...
## 3) Flux vs. Proxy - Direction of Data Flow
...
| --- | --- | --- | --- |
| Flux Module | [redux-toolkit](https://www.npmjs.com/package/@reduxjs/toolkit) | 12 MB | 2 million |
| Flux Module | [zustand](https://www.npmjs.com/package/zustand) | 300 KB | 1.5 million |
| Flux Atomic | [recoil](https://www.npmjs.com/package/recoil) | 2.2 MB | 400k |
| Flux Atomic | [jotai](https://www.npmjs.com/package/jotai) | 400 KB | 450k |
