...
export const sections = [
    ...
    { title: '2) Global Stores - Singleton | Atomic | Proxy', id: '2-global-stores-singleton-vs-atomic-vs-proxy' },
    { title: '3) Global Store Libraries', id: 'table-comparison', indent: true },
