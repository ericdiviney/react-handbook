...
There's no reason you can't or shouldn't follow an organization template like we describe on our normal <Resource url='/project-structure'>Project Structure</Resource> page.
...
There's nothing particularly unique in React Native that would keep you from implementing the same general project practices we recommend on our <Resource url='/project-structure#component-format'>Project Structure</Resource> page. So for organizing your component files and folder structure we do recommend the same approach.
