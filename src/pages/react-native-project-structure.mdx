...
For organizing your individual component files in a consistent manner - check out the sample component we present on the [Project Structure](/project-structure#component-format) page.
