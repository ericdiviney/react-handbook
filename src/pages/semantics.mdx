...
Do NOT treat accessibility as something you can add to your app “after” its done but before launching. You are pretty likely to either miss accessibility concerns altogether or create solutions that end up causing more headaches for people using accessibility tech.
