...
- With the [recent updates](https://astro.build/blog/astro-2100/) to Astro, this is actually becoming a very compelling alternative tech-stack for applications. 
