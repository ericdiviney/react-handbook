...
- Remix is built more on top of standard Web APIs, Next pushes more of a Node.js approach (for now)
...
In a year or so, I could easily see myself recommending Remix for the vast majority of websites + web apps. For now, I'm hoping the community and project itself will mature a bit more before becoming my #1 recommendation. FWIW - I'm really excited to watch the future of Remix and think you could start building production applications with it today, Next.js is just (right now) the more mature option and probably used more in production.
