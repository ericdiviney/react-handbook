...
Creating aliases for cleaner imports is amazing. Consider using `babel-plugin-module-resolver`. To avoid long-nested imports (e.g., `import Component from '../../long/nested/import/direcotry/components/Component'`) which can make this into a much cleaner import such as `import { Component } from '@components'`.
