		...
		<div className='max-w-screen-xl pr-2 mx-auto overflow-x-auto'>
			<div className='min-w-[600px]'>
					...
					<div className='flex basis-3/4'>
						...
						<div className='w-1/3 px-2'>
							<div className='flex items-center gap-4'>
								...
								<span className='hidden text-sm font-bold tracking-widest uppercase lg:block'>Remix</span>
							</div>
						</div>
					</div>
				</div>
				...
				<div className='flex justify-between p-6 my-2'>
					...
					<div className='flex w-3/4'>
						<div className='w-1/3 px-2'>Static websites, Content-driven websites, SEO-friendly websites, High-traffic sites w/ non-dynamic content (Blogs, Marketing, Portfolio, Documentation)</div>
						<div className='w-1/3 px-2'>Static websites, SEO-friendly rendering, Fast dynamic apps/sites, SPAish Support (via export)</div>
						<div className='w-1/3 px-2'>SEO-friendly rendering, Fast dynamic apps/sites, Deploying &quot;to the edge&quot;</div>
					</div>
				</div>
				<div className='flex justify-between p-6 my-2'>
					<div className='basis-1/4'>Not Good for:</div>
					<div className='flex w-3/4'>
						<div className='w-1/3 px-2'>Dynamically generated content like search results, user-generated feeds, admin dashboards</div>
						<div className='w-1/3 px-2'>
							<div className='mb-4'>If you have absolutely no requirement for server-side react now or ever</div>
							<div>If your team has opinionated stances on functionality like routing, data fetching, etc.</div>
						</div>
						<div className='w-1/3 px-2'>
							<div className='mb-4'>Medium-Large apps (think enterprise SPAs)</div>
				...
				<div className='flex justify-between p-6 my-2 rounded-xl bg-slate-100 dark:bg-zinc-800'>
					...
					<div className='flex w-3/4'>
						<div className='w-1/3 px-2'>
							<div className='mb-4'>
								<a href='https://www.gatsbyjs.com/docs/tutorial/' target="_blank" rel="noreferrer">Gatsby Tutorial</a>
							</div>
							<div className='mb-4'>
								<a href='https://www.youtube.com/watch?v=b2H7fWhQcdE' target="_blank" rel="noreferrer">Getting Started With Gatsby</a>
							</div>
							<div>
								<a href='https://egghead.io/courses/build-a-blog-with-react-and-markdown-using-gatsby' target="_blank" rel="noreferrer">Build a Blog with Markdown &amp; Gatsby</a>
							</div>
							
						</div>
						<div className='w-1/3 px-2'>
							<div className='mb-4'>
								<a href='https://nextjs.org/learn/basics/create-nextjs-app' target="_blank" rel="noreferrer">Next.js Tutorial</a>
							</div>
							<div>
								<a href='https://egghead.io/courses/introduction-to-next-js-9-9c01' target="_blank" rel="noreferrer">Introduction to Next.js by Xiaoru Li</a>
							</div>
						</div>
						<div className='w-1/3 px-2'>
							<div className='mb-4'>
								<a href='https://remix.run/docs/en/v1/tutorials/jokes' target="_blank" rel="noreferrer">Remix Tutorial</a>
							</div>
							<div className='mb-4'>
								<a href='https://egghead.io/courses/up-and-running-with-remix-b82b6bb6' target="_blank" rel="noreferrer">Up &amp; Running With Remix by Kent C. Dodds</a>
							</div>
							<div>
								<a href='https://www.youtube.com/watch?v=hsIWJpuxNj0' target="_blank" rel="noreferrer">Remix Tutorial with Kent C. Dodds</a>
							</div>
						</div>
					</div>
				</div>
				<div className='flex justify-between p-6 my-2 bg-emerald-50 dark:bg-transparent rounded-xl'>
					...
					<div className='flex w-3/4'>
						...
						<div className='w-1/3 px-2'>
							<div className='mb-4'>Next.js is the more battle-tested library in production, so you&apos;re less likely to encounter bugs that you&apos;ll have to report to the framework authors.</div>
						</div>
						<div className='w-1/3 px-2'>
							<div className='mb-4'>Remix has a pretty mature solution for <a href='https://remix.run/blog/lazy-loading-routes' target='_blank' rel="noreferrer">avoiding Network Waterfalls</a>.</div>
							<div className='mb-4'>Remix will probably work better out-of-the-box for apps that require support in older browsers like Safari 8-9 or IE 9-11.</div>
							<div>Simple architecture. Conceptually, a shift back towards MPA (Multi Page App) architectures like RoR (Ruby), Laravel (PHP), etc.</div>
						</div>
					</div>
				</div>
				...
				<div className='flex justify-between p-6 my-2'>
					...
					<div className='flex w-3/4'>
						...
						<div className='w-1/3 px-2'>
							Next.js <strong>strongly encourages</strong> a Node.js runtime to serve/run the app (not required if you do a static export). Gatsby and Remix do not.
						</div>
						<div className='w-1/3 px-2'>
							<div className='mb-4'>Remix generally encourages you to move a lot of typical client-side &quot;state&quot; to the edge/server, sometimes removing the need to manage a &quot;state&quot; in the frontend altogether.</div>
							<div className='mb-4'>Remix generally encourages you to fetch data for your apps/components from the edge/server via &quot;loader functions&quot;.</div>
							<div className='mb-4'>While the router / nested routes bring a big performance boost to your app, there&apos;s also a bit of a learning curve. This is a moot point if you&apos;re also considering the App Router in Next.js, as that also comes with a learning curve.</div>
							<div>Remix doesn&apos;t support SSG (which in a lot of cases is probably fine if your goals are simply to deliver a fast user experience).</div>
						</div>
					</div>
				</div>
				...
				<div className='flex justify-between p-6 my-2 rounded-xl bg-slate-100 dark:bg-zinc-800'>
					...
					<div className='flex w-3/4'>
						...
						<div className='w-1/3 px-2'>
							<a href="https://www.shopify.com/" target="_blank" rel="noreferrer">Shopify</a>
						</div>
					</div>
				</div>
			</div>
