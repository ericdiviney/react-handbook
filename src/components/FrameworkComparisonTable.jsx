    ...
    <div className="mx-auto max-w-screen-xl overflow-x-auto pr-2">
      <div className="min-w-[600px]">
        ...
        <div className="my-2 flex justify-between rounded-xl bg-rose-50 p-6 dark:bg-transparent">
          ...
          <div className="flex w-3/4">
            ...
            <div className="w-1/3 px-2">
              ...
              More:{' '}
              <PageLink
                link="https://redd.one/blog/my-struggle-with-remix"
                label="My Struggle With Remix"
              />
            </div>
          </div>
        </div>
        ...
        <div className="my-2 flex justify-between rounded-xl bg-slate-100 p-6 dark:bg-zinc-800">
          ...
          <div className="flex w-3/4">
            <div className="w-1/3 px-2">
              <PageLink link="https://www.netlify.com/" label="Netlify" />
            </div>
            <div className="w-1/3 px-2">
              <PageLink link="https://vercel.com/" label="Vercel" />
            </div>
            <div className="w-1/3 px-2">
              <PageLink link="https://www.shopify.com/" label="Shopify" />
            </div>
          </div>
        </div>
      </div>
