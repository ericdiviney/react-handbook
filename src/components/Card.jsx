...
export function Card({ resource }) {
    return (
        <div
            key={resource.href}
            className="group relative flex rounded-xl bg-indigo-50 bg-opacity-90 transition-shadow hover:ring-1 ring-indigo-900/6 hover:shadow-xl hover:shadow-indigo-900/5 dark:bg-white/2.5 dark:hover:shadow-black/5"
        >
            <div className="absolute inset-0 rounded-xl ring-1 ring-inset ring-indigo-900/7.5 group-hover:ring-indigo-900/10 dark:ring-white/10 dark:group-hover:ring-white/20" />
            <div className="relative px-4 pt-8 pb-4 rounded-xl">
                ...
                <p className="pb-4 mt-1 text-sm text-zinc-600 dark:text-zinc-400">
